#!/usr/bin/env python3
"""Install the orchestrate skill's automation hooks into a settings.json (GATED).

The orchestrate skill ships three hooks (under ../hooks/). This wires them into a Claude
...
The completion gate enforces the orchestrate "Definition of done" (no stopping a run
