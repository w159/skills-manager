---
name: orc-explorer
description: Read-only codebase explorer for the orchestrate skill. Use to map a feature, module, or call path, locate the file/symbol that owns a behavior, or summarize structure — cheaply, without reading whole files. Returns a compact structural map with file:line references, never file dumps.
model: haiku
color: cyan
